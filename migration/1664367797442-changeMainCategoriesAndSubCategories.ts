    ...
    if (projectCategoryRelationTableExists) {
      ...
      await queryRunner.query(
        `
                ...
                WHERE name NOT IN ('agriculture','air','conservation-and-biodiversity','sustainable-cities-and-communities','ocean','climate-action','water-and-sanitation','housing','employment','refi','food','health-care','tech','grassroots','art','inclusion','registered-non-profits','other','nutrition','energy', 'real-estate', 'infrastructure')
              `,
      );
    }
  }
