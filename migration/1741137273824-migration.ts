...
export class Migration1741137273824 implements MigrationInterface {
  name = 'Migration1741137273824';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "qacc_points_history" ("id" SERIAL NOT NULL, "pointsEarned" real NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, "donationId" integer, CONSTRAINT "PK_0b3ac7e10a5f507563d62120b0e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
