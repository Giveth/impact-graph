  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "project" ADD "rewardStreamStart" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "project" ADD "rewardStreamEnd" TIMESTAMP`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "project" DROP COLUMN "rewardStreamEnd"`,
    );
    await queryRunner.query(
      `ALTER TABLE "project" DROP COLUMN "rewardStreamStart"`,
    );
    await queryRunner.query(
