...
export class CreateProjectActualMatchingViewV21708252061900 implements MigrationInterface {
        ...
        await queryRunner.query(
          `
            ...
            SELECT 
                ...
                p.slug, 
                p.title,
                qr.id as "qfId",  qr."minimumPassportScore" as "minimumPassportScore",
