...
export class projectActualMatchingV101709755736838
    ...
    await queryRunner.query(`
        ...
        WITH DonationsBeforeAnalysis AS (
            ...
            FROM
                ...
                INNER JOIN project_address pa ON pa."projectId" = p.id AND pa."networkId" = ANY(qr."eligibleNetworks") AND pa."isRecipient" = true
            WHERE
                d."status" = 'verified'
