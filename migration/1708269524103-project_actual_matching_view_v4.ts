...
export class ProjectActualMatchingViewV41708269524103
  implements MigrationInterface
{
  // Read passport score from user_passport_score instead of user.passportScore
