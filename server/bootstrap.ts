...
import { authorizeGivethTrace, updateTraceableProjectsHandler } from '../services/trace/traceService';
...
export async function bootstrap () {
  try {
    ...
    app.put('/traceableProject/:id', authorizeGivethTrace, updateTraceableProjectsHandler)
