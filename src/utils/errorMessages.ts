...
export const errorMessages = {
  ...
  QF_ROUND_NOT_ACTIVE: 'QF round is not active',
  QF_ROUND_NOT_CURRENTLY_ACTIVE: 'QF round is not currently active',
  QF_ROUND_NOT_ELIGIBLE_FOR_NETWORK:
    'QF round is not eligible for this network',
  PROJECT_NOT_PART_OF_QF_ROUND: 'Project is not part of the specified QF round',
  ...
  ONLY_DRAFTED_PROJECTS_CAN_BE_DELETED: 'Only drafted projects can be deleted',
  ...
  CAUSE_TITLE_ALREADY_EXISTS: 'Cause title already exists',
  CAUSE_NOT_FOUND: 'Cause not found',
  ...
  CAUSE_CREATION_FEE_RECIVER_NOT_CONFIGURED:
    'Cause creation fee reciver not configured in environment variables',
};
...
export const translationErrorMessagesKeys = {
  ...
  QF_ROUND_NOT_FOUND: 'QF_ROUND_NOT_FOUND',
  QF_ROUND_NOT_ACTIVE: 'QF_ROUND_NOT_ACTIVE',
  QF_ROUND_NOT_CURRENTLY_ACTIVE: 'QF_ROUND_NOT_CURRENTLY_ACTIVE',
  QF_ROUND_NOT_ELIGIBLE_FOR_NETWORK: 'QF_ROUND_NOT_ELIGIBLE_FOR_NETWORK',
  PROJECT_NOT_PART_OF_QF_ROUND: 'PROJECT_NOT_PART_OF_QF_ROUND',
  ONRAMPER_SIGNATURE_INVALID: 'ONRAMPER_SIGNATURE_INVALID',
  ONRAMPER_SIGNATURE_MISSING: 'ONRAMPER_SIGNATURE_MISSING',
  ONLY_DRAFTED_PROJECTS_CAN_BE_DELETED: 'ONLY_DRAFTED_PROJECTS_CAN_BE_DELETED',
  ...
  CAUSE_TITLE_ALREADY_EXISTS: 'CAUSE_TITLE_ALREADY_EXISTS',
