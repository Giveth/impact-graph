export const errorMessages = {
  CATEGORIES_LENGTH_SHOULD_NOT_BE_MORE_THAN_FIVE: 'Please select no more than 5 categories',
  ...
  TRANSACTION_FROM_ADDRESS_IS_DIFFERENT_FROM_SENT_FROM_ADDRESS:
    'Transaction\'s fromAddress is different from sent fromAddress',
  TRANSACTION_TO_ADDRESS_IS_DIFFERENT_FROM_SENT_TO_ADDRESS:
    'Transaction\'s toAddress is different to sent toAddress',
  ...
  TRANSACTION_NOT_FOUNT_IN_USER_HISTORY: 'TRANSACTION_NOT_FOUNT_IN_USER_HISTORY',
  TO_ADDRESS_OF_DONATION_SHOULD_BE_PROJECT_WALLET_ADDRESS: 'toAddress of donation should be equal to project wallet address'
}
